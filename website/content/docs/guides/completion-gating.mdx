...
<Callout>
This mode was called `openMissionOnly` before 0.3. That spelling is still accepted — on both
platforms and for alarms already persisted by an older build — and will be removed in 1.0. Whichever
