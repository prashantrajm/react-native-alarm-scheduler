...
On **Android** this returns the currently ringing alarm with `state: 'alerting'`, a waiting deferred
or follow-up occurrence with `state: 'countdown'`, then falls back to a
